            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="••••••••" 
                  required
                  className="w-full h-14 pl-6 pr-12 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 text-[#0B1B3D] dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all font-bold text-sm"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:text-blue-200/40 dark:hover:text-blue-200/60 focus:outline-none transition-colors"
                >
                  {showPassword ? (
